                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="{admin_url}Lap_data_antrian_staff?aksi=get_data_laporan_antrian_staff" method="POST">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-list"></i> Form {title}</h3>
                                </div>
                                                ...
                                                <div class="col-md-9">                                                               
                                                    <select class="form-control select" name="panggilan[]" multiple>
                                                        <? foreach($this->Laporan->get_mruang_jenis() as $row): ?>
                                                            <? if($this->session->userdata('user_grup_id') == $row->id): ?>
                                                                <option selected value="<?= $row->id ?>"><?= $row->jenis_ruang ?></option>
                                                            <? endif ?>
                                                        <? endforeach ?>
                                                    </select>
                                                </div>                                                
                                            ...
                                            <div style="display:none" class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="ruang[]" multiple>
                                                        <option selected value="<?= $this->Laporan->get_mruang_staff()->kode ?>"><?= $this->Laporan->get_mruang_staff()->nama_ruang ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    <? $no=1; foreach($laporan as $row): ?>
                                                        <tr class="active">
                                                            ...
                                                            <td><?= $this->Laporan->get_mruang_staff()->nama_ruang ?></td>
