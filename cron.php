...
define('CRON_CI_INDEX', '/home/vlegalin/public_html/certification/index.php');   // Your CodeIgniter main index.php file
...
foreach($argv as $arg)
{
    ...
    switch($param)
    {
        case '--run':
            ...
            $_SERVER['SERVER_NAME'] = 'localhost/certification';
            $required['--run'] = TRUE;
        break;
